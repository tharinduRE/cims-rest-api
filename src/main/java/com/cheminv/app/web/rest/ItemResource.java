...
/**
 * REST controller for managing {@link com.cheminv.app.domain.Item}.
 */
@RestController
@RequestMapping("/api")
public class ItemResource {
     ...
     */
    @GetMapping("/items")
    public List<ItemDTO> getAllItems(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
