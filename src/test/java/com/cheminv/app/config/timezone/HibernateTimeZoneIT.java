package com.cheminv.app.config.timezone;

import com.cheminv.app.CimsApp;
import com.cheminv.app.repository.timezone.DateTimeWrapper;
import com.cheminv.app.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM cims_date_time_wrapper where id=%d", fieldName, id);
    }
